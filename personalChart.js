...
const getChartOptions = () => {
  return {
    ...
    labels: ["grocery", "travel", "rent", "tuition"],
    dataLabels: {
      enabled: false,
    },
    legend: {
...
const updateBarChart = (budgetData, spendingData) => {
  const categories = ['grocery', 'travel', 'rent', 'tuition'];
...
// Example data
const budgetData = [200, 150, 300, 250]; // Total budget for each category
const spendingData = [95, 70, 150, 120]; // Amount spent in each category
